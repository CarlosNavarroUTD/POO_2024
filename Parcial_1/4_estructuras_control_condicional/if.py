#Esta estructura de control evalua una condicion si la condicion se cumple se ejecuta la o las intrucciones contenidas dento de ella +
...
color=input("Ingresa el color:Azul")
